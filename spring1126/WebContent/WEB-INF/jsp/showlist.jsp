   ...
   <tbody>
    <c:forEach var="listv" items="${list}">
     <tr>
      ...
      <td>${listv.price}</td>
      <td>${listv.regdate}</td>
      <td><a href="fileDown?fileName=${listv.path}" style="width:50px; color:#0f0f0f">down</a></td>
     </tr>
    </c:forEach>
   </tbody>
   <tfoot>
       ...
       <c:when test="${searchType == null}">
        <c:choose>
         <c:when test="${pageInfo.currentBlock eq 1}">
          <img src="resources/imgfile/prev.jpg">
         </c:when>
         <c:otherwise>
          <a
    ...
    <tr>
    	<th colspan="5"><a href="downloadExcel" style="color:black">Download Excel</a></th>
    </tr>
   </tfoot>
  </table>
 </div>
